...
export const InvalidComponentsWithoutClassName = () => {
  return (
    <div>
      {' '}
      {/* ERROR: HTML element without className */}
      <div>This div should trigger an error - no className</div> {/* ERROR */}
      <span>This span should trigger an error - no className</span>{' '}
      {/* ERROR */}
      <p>This paragraph should trigger an error - no className</p> {/* ERROR */}
      <button>This button should trigger an error - no className</button>{' '}
      {/* ERROR */}
      ...
      <section>
        This section should trigger an error - no className
      </section>{' '}
      {/* ERROR */}
      <article>
        This article should trigger an error - no className
      </article>{' '}
      {/* ERROR */}
      <nav>This nav should trigger an error - no className</nav> {/* ERROR */}
      <header>This header should trigger an error - no className</header>{' '}
      {/* ERROR */}
      <footer>This footer should trigger an error - no className</footer>{' '}
      {/* ERROR */}
      <main>This main should trigger an error - no className</main>{' '}
      {/* ERROR */}
      <aside>This aside should trigger an error - no className</aside>{' '}
      {/* ERROR */}
      <form>This form should trigger an error - no className</form>{' '}
      {/* ERROR */}
      <label>This label should trigger an error - no className</label>{' '}
      {/* ERROR */}
      <textarea>
        This textarea should trigger an error - no className
      </textarea>{' '}
      {/* ERROR */}
      <select>This select should trigger an error - no className</select>{' '}
      {/* ERROR */}
      <option value="test">
        This option should trigger an error - no className
      </option>{' '}
      {/* ERROR */}
      ...
      <table>This table should trigger an error - no className</table>{' '}
      {/* ERROR */}
      <thead>This thead should trigger an error - no className</thead>{' '}
      {/* ERROR */}
      <tbody>This tbody should trigger an error - no className</tbody>{' '}
      {/* ERROR */}
...
export const InvalidComponentsWithEmptyClassName = () => {
  return (
    <div className="container">
      <div className="">This div should trigger an error - empty className</div>{' '}
      {/* ERROR */}
      <span className="">
        This span should trigger an error - empty className
      </span>{' '}
      {/* ERROR */}
      <p className="">
        This paragraph should trigger an error - empty className
      </p>{' '}
      {/* ERROR */}
      <button className="">
        This button should trigger an error - empty className
      </button>{' '}
      {/* ERROR */}
      <input className="" type="text" /> {/* ERROR */}
      <img className="" src="test.jpg" alt="test" /> {/* ERROR */}
      <h1 className="">
        This heading should trigger an error - empty className
      </h1>{' '}
      {/* ERROR */}
      <section className="">
        This section should trigger an error - empty className
      </section>{' '}
      {/* ERROR */}
      <ul className="">
        This ul should trigger an error - empty className
      </ul>{' '}
      {/* ERROR */}
      <li className="">
        This li should trigger an error - empty className
      </li>{' '}
      {/* ERROR */}
    </div>
  )
  ...
  return (
    <div className="container">
      ...
      <section className="valid-section">
        {' '}
        {/* VALID */}
        <p>This paragraph has no className - should trigger error</p>{' '}
        {/* ERROR */}
