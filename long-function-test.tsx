...
// This function should trigger max-lines-per-function warning (over 100 lines)
function VeryLongFunction() {
  ...
  const line101 = 'line 101'; // This should trigger the warning
...
export default VeryLongFunction;